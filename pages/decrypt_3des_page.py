...
def decrypt_triple_des():
    ...
    def handle_encryption(event=None):
        ...
        if (plaintext and key):
            ...
            plaintext = triple_des_decrypt(ciphertext, keyb, triple_des_keys)
            print("Triple DES Decrypted Plain Text:", plaintext)

            '''
            i copied the same from encrypt, just change the rest down here
            '''
